package org.zerock.bimovie.security;
...
import org.zerock.bimovie.security.filter.ApiCheckFilter;
import org.zerock.bimovie.security.filter.ApiLoginFilter;
import org.zerock.bimovie.security.handler.ApiLoginFailHandler;
import org.zerock.bimovie.security.handler.CustomAccessDeniedHandler;
import org.zerock.bimovie.security.handler.CustomLoginSuccessHandler;
import org.zerock.bimovie.security.handler.CustomLogoutSuccessHandler;
import org.zerock.bimovie.security.service.CommonUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    private CommonUserDetailsService biUserDetailsService;
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.rememberMe().tokenValiditySeconds(60*60*24*7)
            .userDetailsService(biUserDetailsService);
